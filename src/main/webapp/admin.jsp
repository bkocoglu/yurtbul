...
<div style="overflow: hidden;">
    <div class="row" id="homePage" style="margin: 0px;">
        <div class="col-md-2" id="yanMenu" style="padding-right: 20px; padding-left: 20px;">
            ...
            <button id="yorumlarButton" class="button btn btn-info col-lg" style="width: 100%; margin-left: 0px;"><span>Onay Bekleyen<br> Yorumlar(0)</span></button>
            <button id="goruntulenmeButton" class="button btn btn-info col-lg" style="width: 100%; margin-left: 0px;"><span>Görüntülenme<br>ve<br>Silme</span></button>
        </div>
        ...
        <div class="col-md" id="showCase" >
                    ...
                    <form action="createAdvert" enctype="multipart/form-data" accept-charset="utf-8">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="name" type="text" class="form-control is-invalid" id="validationServer03" placeholder="İşletme Adı" required>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input name="addressDetail" type="text" class="form-control is-invalid" id="validationServer03" placeholder="Adres Detay" required/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            ...
                            <p style="width: 100%; font-weight: bold; font-size: x-small; margin-bottom: 10px;">
                                İşletmenizin Google Map'te gözükebilmesi için doğru koordinatları girmeniz tavsiy edilir.
                            </p>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-3">
            ...
            <div id="onayBekleyenYorumlar">
                <div class="row yorumItem">
                    <p class="yorumYapan">Bilal Koçoğlu<span style="float: right;">03.12.2017</span></p>
                    <p class="yorumMetni">Çok güzel bir yurtmuş herkese tavsiye ederim.</p>
            ...
            <div id="goruntulenme">
                <div class="row yorumItem" style="font-size: small; font-weight: bold; text-align: center; display: table;">
                    <div class="col" style="display: table-cell; vertical-align: middle;">
                        <p>Hasan Cantürk Yurdu</p>
                    </div>
                    <div class="col" style="display: table-cell; vertical-align: middle;">
                        <p>10 Görüntülenme</p>
                    </div>
                    <div class="col" style="text-align: right; display: table-cell;">
                        <a class="btn btn-danger" href="#" role="button">Sil</a>
                    </div>
                </div>
                <div class="row yorumItem" style="font-size: small; font-weight: bold; text-align: center; display: table;">
                    <div class="col" style="display: table-cell; vertical-align: middle;">
